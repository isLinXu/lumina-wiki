...
**▸ 更新于 2026-04-23T00:50:28Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出 [[FlashAttention]] 算法，通过分块计算和重计算策略显著降低 [[Self-Attention]] 的内存占用，同时保持数学等价性。该方法在多个任务中实现了显著的加速和扩展性提升。

**相关实体**: [[FlashAttention]] | [[IO 感知]] | [[分块计算]] | [[在线 Softmax]] | [[反向传播重计算]] | [[FlashAttention-2]] | [[FlashAttention-3]] | [[PyTorch]] | [[xFormers]]


---

**▸ 更新于 2026-04-24T00:50:58Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出FlashAttention算法，通过分块计算和重计算策略显著降低自注意力机制的内存占用，同时保持数学等价性。该方法在保持精度的前提下提升了计算效率，支持更长的序列长度，并已在多个框架中集成。

**相关实体**: [[FlashAttention]] | [[IO感知设计]] | [[分块计算]] | [[重计算]] | [[在线Softmax]] | [[反向传播重计算]] | [[FlashAttention-2]] | [[FlashAttention-3]] | [[PyTorch]] | [[xFormers]] | [[Triton]]


---

**▸ 更新于 2026-04-25T00:46:15Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出 [[FlashAttention]] 算法，通过分块计算和重计算策略显著降低 [[Self-Attention]] 的内存占用，同时保持数学等价性。该方法在多个任务中实现了显著的加速和扩展性提升。

**相关实体**: [[FlashAttention]] | [[IO 感知设计]] | [[分块计算]] | [[在线 Softmax]] | [[反向传播重计算]] | [[FlashAttention-2]] | [[FlashAttention-3]] | [[Hopper 架构]]


---

**▸ 更新于 2026-04-26T00:51:31Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`
...
**▸ 更新于 2026-05-15T00:56:52Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出 [[FlashAttention]] 算法，通过分块计算和重计算策略显著降低 [[Self-Attention]] 的内存占用，同时保持数学等价性。该方法在多个任务中实现了显著的加速和扩展性提升。

**相关实体**: [[FlashAttention]] | [[IO 感知]] | [[分块计算]] | [[重计算]] | [[在线 Softmax]] | [[反向传播重计算]] | [[FlashAttention-2]] | [[FlashAttention-3]]


---

**▸ 更新于 2026-05-16T00:53:35Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出FlashAttention算法，通过分块计算和重计算策略显著降低自注意力机制的内存占用，同时保持数学等价性。该方法在多个基准测试中表现出色，提升了大规模模型训练效率。

**相关实体**: [[FlashAttention]] | [[Tiling]] | [[Online Softmax]] | [[GPT-2]] | [[BERT-large]] | [[A100]] | [[FlashAttention-2]] | [[FlashAttention-3]]


---

**▸ 更新于 2026-05-17T00:59:32Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出FlashAttention算法，通过分块计算和重计算策略显著降低自注意力机制的内存占用，同时保持数学等价性。该方法在保持精度的前提下提升了计算效率，支持更长的序列长度，并已在多个框架中集成。

**相关实体**: [[FlashAttention]] | [[IO 感知设计]] | [[分块计算]] | [[重计算策略]] | [[在线 Softmax]] | [[反向传播重计算]] | [[FlashAttention-2]] | [[FlashAttention-3]] | [[PyTorch]] | [[xFormers]] | [[Triton]]


---

**▸ 更新于 2026-05-18T01:00:52Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`
...
**▸ 更新于 2026-05-19T01:01:16Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出FlashAttention算法，通过分块计算和重计算策略显著降低自注意力机制的内存占用，同时保持数学等价性。该方法在保持精度的前提下提升了计算效率，支持更长的序列长度。
...
**▸ 更新于 2026-05-21T01:02:58Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出 [[FlashAttention]] 算法，通过分块计算和重计算策略显著降低 [[Self-Attention]] 的内存占用，同时保持数学等价性。该方法在多个任务中实现了显著的加速和扩展性提升。

**相关实体**: [[FlashAttention]] | [[IO 感知]] | [[分块计算]] | [[重计算]] | [[在线 Softmax]] | [[FlashAttention-2]] | [[FlashAttention-3]]


---

**▸ 更新于 2026-06-23T01:00:00Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`
...
**▸ 更新于 2026-09-15T04:02:36Z**
> 来源: `raw/2026-04-06/FlashAttention_Paper.md`

**补充摘要**: 本文提出 [[FlashAttention]]，一种 IO 感知的精确注意力算法，通过分块计算和重计算策略显著降低内存占用并提升计算效率。该方法在保持数学等价性的前提下优化了 GPU 内存访问模式，提升了大规模序列处理能力。

**相关实体**: [[FlashAttention]] | [[A100]] | [[BERT-large]] | [[GPT-2]]
